    ...
    return (
      <>
        {this.props.githubLink ? (
          <GithubIcon link="https://github.com/chinnaxs/portfolio" size="25" />
        ) : null}
      </>
    );
  }
  ...
  renderProjectImage() {
    return (
      <>
        {this.props.imgSrc ? (
          <img
            className="object-contain rounded shadow-sm shadow-gray "
          ...
          <svg
            ...
            width="64"
            height="64"
            className="fill-gray mx-auto shadow-sm "
          >
            <path
              fill-rule="evenodd"
